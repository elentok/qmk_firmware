...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    ...
    KC_F5,                 KC_VOLD,  KC_LCTL, LCTL_T(KC_A),    LGUI_T(KC_S),    KC_D,    LT(_FN1, KC_F), KC_G,             KC_H,    KC_J,     KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_PGUP,
    KC_F7,                 KC_F8,    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,           KC_B,             KC_N,    KC_M,     KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_PGDN,
    KC_F9,                 KC_F10,   KC_LCTL, MO(_FN1),KC_LALT, KC_LGUI, KC_SPC,         LT(_FN1, KC_SPC), MO(_FN1), KC_RALT, KC_RCTL, KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT
  ),
