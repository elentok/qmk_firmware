...
* |-----------------------------------------------------------------------------------------+
* | Control |  a  |  s  |  d  |  L1(f)  |  g  |  h  |  j  |  k  |  l  |  ;  |  '  |    Enter    |
* |-----------------------------------------------------------------------------------------+
...
*/
 ...
 [BASE] = LAYOUT_60_ansi( /* Base */
    ...
    KC_LCTL,          LCTL_T(KC_A), KC_S,    KC_D, LT(FN1, KC_F), KC_G, KC_H, LT(FN1, KC_J),  KC_K, KC_L,    KC_SCLN,          KC_QUOT,          KC_ENT,
    KC_LSFT,          KC_Z,    KC_X, KC_C, KC_V, KC_B,   KC_N, KC_M, KC_COMM, KC_DOT,           KC_SLSH,          RSFT_T(KC_UP),
    KC_LCTL,          KC_LALT, KC_LGUI,                    LGUI_T(KC_SPC),             KC_RALT, LT(FN1, KC_LEFT), LT(FN2, KC_DOWN), RCTL_T(KC_RGHT)
),
  /*
  * Layer FN1
  * ,-----------------------------------------------------------------------------------------.
 ...
 [FN1] = LAYOUT_60_ansi( /* FN1 */
    ...
    _______, _______, _______, KC_LBRC, KC_RBRC, _______, KC_PGUP, KC_VOLU, KC_HOME, _______, KC_PSCR, KC_HOME, KC_END,  _______,
    _______, _______, _______, KC_LPRN, KC_RPRN, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, _______,
    _______,          _______, KC_LCBR, KC_RCBR, _______, _______, KC_PGDN, KC_VOLD, _______, KC_INS,  KC_DEL,  _______,
